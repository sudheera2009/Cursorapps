...
/// Thin wrapper around Google Mobile Ads using Google's official test unit ids.
/// Replace the ids with real ones before shipping to production.
class AdService {
  ...
  void showRewardedAd({
    ...
    if (_isRewardedLoaded && _rewardedAd != null) {
      ...
      // No ad available — grant a small consolation so the UX never dead-ends.
      onRewarded(0);
      onAdClosed?.call();
    }
  }
